...
import { gerarTabelaEmpreendimentoCore } from "./gerar-tabela";
...
export async function gerarTabelaPdfAdmin(
  ...
  const resultado = await gerarTabelaEmpreendimentoCore(empreendimentoId);
  ...
  return { success: true, url: resultado.url, geradoEm: resultado.geradoEm };
}
