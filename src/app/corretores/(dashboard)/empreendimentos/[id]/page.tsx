          ...
          <div className="flex flex-col gap-3 rounded-xl border border-line bg-white p-6">
            ...
            {empreendimento.linkMidiaPublica ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex w-fit items-center justify-center rounded-md bg-accent px-5 py-2.5 text-sm font-semibold text-primary transition hover:bg-accent-light"
              >
                Acessar mídia
              </a>
            ) : (
